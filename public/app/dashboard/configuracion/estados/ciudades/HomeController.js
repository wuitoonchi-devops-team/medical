route = "/dashboard/configuracion/estados/ciudades";
    arrStates = [];
    ...
    window.getData = function() {
        ...
        axios.get(route+"/all/"+$('#estado_id').val()).then(function(res) {
            arrData = res.data;
     ...
     $('#all_disable').click(function() {
        bootbox.confirm({
            ...
            callback: function(result) {
                if (result==true) {
                    axios.get(route+'/disable_all/'+$('#estado_id').val()).then(function(){
    ...
    $('#all_enable').click(function() {
        bootbox.confirm({
            ...
            callback: function(result) {
                if (result==true) {
                        axios.get(route+'/enable_all/'+$('#estado_id').val()).then(function(){
                            getData();
                            Core.showToast('success','Procesao ralizado correctamente');
                        }).catch(function(){
                            Core.showToast('error','No ha sido posible procesar solicitud.');
